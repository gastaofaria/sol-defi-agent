...
export type CloseInput<
  ...
  TAccountDefiagent extends string = string,
> = {
...
>(
  input: CloseInput<TAccountPayer, TAccountDefiagent>,
  config?: { programAddress?: TProgramAddress }
): CloseInstruction<TProgramAddress, TAccountPayer, TAccountDefiagent> {
  // Program address.
  ...
  return Object.freeze({
    accounts: [
      ...
      getAccountMeta(accounts.defiagent),
    ],
    data: getCloseInstructionDataEncoder().encode({}),
    programAddress,
  } as CloseInstruction<TProgramAddress, TAccountPayer, TAccountDefiagent>);
}
...
>(
  ...
  return {
    ...
    accounts: { payer: getNextAccount(), defiagent: getNextAccount() },
